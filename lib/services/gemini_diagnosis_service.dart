...
class GeminiDiagnosisService {
  ...
  DEVICE DIAGNOSTIC KNOWLEDGE BASE:

  Common Device Issues:
  - Battery degradation: Usually occurs after 2-3 years, identified by rapid discharge, overheating
  - Screen damage: Cracks, dead pixels, touch responsiveness issues
  - Water damage: Corrosion, non-responsive components, moisture indicators
  - Software issues: Slow performance, crashes, unresponsive apps
  - Hardware failures: Speaker/microphone problems, camera issues, charging port damage

  Device Value Factors:
  - Age of device (major factor)
  - Market demand and availability
  - Condition (screen, battery, hardware)
  - Storage capacity
  - Regional market conditions (Philippines/Davao)
  - Brand reputation and support

  Repair Cost Estimates (Philippines market):
  - iPhone screen replacement: ₱3,000-₱8,000
  - Android screen replacement: ₱1,500-₱5,000
  - Battery replacement: ₱800-₱3,000
  - Charging port repair: ₱500-₱2,000
  - Water damage repair: ₱2,000-₱10,000

  Recommended Actions:
  - High value devices (>₱15,000): Consider repair if cost <40% of current value
  - Medium value devices (₱5,000-₱15,000): Evaluate repair vs replacement
  - Low value devices (<₱5,000): Consider donation or recycling
  - Devices with multiple issues: Often better to recycle or donate
  ''';
  ...
  Future<DiagnosisResult> diagnoseMobileDevice(
    ...
    try {
      ...
      final prompt = _buildDiagnosisPrompt(diagnosis, imageAnalysis);
